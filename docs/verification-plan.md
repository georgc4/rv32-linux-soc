...
| ASIC | Logical TT wrapper and pin-level UART test pass; 5×4 SKY26d physical sweep is running | Routed GDS, timing, DRC/LVS, power and pad rules, then demoboard UART test |
