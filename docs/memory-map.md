...
The ROM accepts a bounded word count and checksum in a 16-byte flash header, copies the M-mode loader to PSRAM, and jumps there. The flash package places the loader at offset `0x10`, a second-stage manifest at `0x40000`, the DTB at `0x40020`, and the Linux Image at `0x41000`. The loader copies the DTB to `0x803f0000` and Image to `0x80400000`, then enters S-mode.
